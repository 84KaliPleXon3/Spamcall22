...
def balik():
    ...
    if d == "y":
       subprocess.call("python call22.py",shell=True)
    elif d == "t":
         print ("\033[1;91mExit")
         os.system("exit")
bersih()
subprocess.call("figlet Spamcall22 |lolcat",shell=True)
banner = """
\033[1;97m
==================================================
...
time.sleep(2)
subprocess.call("nano call22.py",shell=True)
print ("\033[1;92mLoading\033[1;97m...")
time.sleep(2)
head = {
"X-Requested-With": "XMLHttpRequest",
"User-Agent": "Mozilla/5.0 (Linux; Android 9; SM-A107F) AppleWebKit/537.36 (KHTML, like Albimo) Chrome/80.0.3987.162 Mobile Safari/537.36",
